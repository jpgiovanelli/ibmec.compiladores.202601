...
\noindent\textbf{Nota de compilação no Overleaf:} este arquivo utiliza \texttt{\textbackslash lstinputlisting} para incluir os códigos-fonte completos. Ao subir no Overleaf, envie também os arquivos \texttt{lexer\_completo\_sem\_comentarios.c} e \texttt{parser\_completo\_sem\_comentarios.c} na mesma pasta do \texttt{teste.tex}.
...
\lstinputlisting[
  ...
  numbers=left,
  numberstyle=\tiny
]{lexer_completo_sem_comentarios.c}
...
\lstinputlisting[
  ...
  numbers=left,
  numberstyle=\tiny
]{parser_completo_sem_comentarios.c}
